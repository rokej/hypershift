...
require (
	...
	open-cluster-management.io/sdk-go v1.1.1-0.20260128013609-7a2e40f02c1d // indirect
...
// Local maestro for hcp apply_resource integration
replace github.com/openshift-online/maestro => ../maestro
